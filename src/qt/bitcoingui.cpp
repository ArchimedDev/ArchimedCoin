    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Archimed Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Archimed address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and archimed: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Archimed Core"), this);
    aboutAction->setStatusTip(tr("Show information about Archimed Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Archimed Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Archimed addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Archimed addresses"));
    ...
    openAction->setStatusTip(tr("Open a archimed: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Archimed Core help message to get a list with possible Archimed Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Archimed Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Archimed network", "", count));
    } else {
...
{
    QString strTitle = tr("Archimed Core"); // default title
