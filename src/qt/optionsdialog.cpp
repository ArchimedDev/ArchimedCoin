    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ARHM-light"), QVariant("light"));
    ui->theme->addItem(QString("ARHM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ARHM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ARHM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ARHM-traditional"), QVariant("trad"));
