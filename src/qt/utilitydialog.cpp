    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Archimed Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Archimed Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  archimed-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Archimed in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ARHM, 0.1 ARHM, 1 ARHM and 10 ARHM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ArchimedDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://ArchimedDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Archimed Core is shutting down...") + "<br /><br />" +
