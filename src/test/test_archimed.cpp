...
#define BOOST_TEST_MODULE Archimed Test Suite

#include "test_archimed.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_archimed_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
