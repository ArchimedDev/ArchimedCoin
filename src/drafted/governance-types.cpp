...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ArchimedNetwork") type = ArchimedNetwork;
    if(strType == "ArchimedNetworkVariable") type = ArchimedNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ArchimedNetwork) s = "ArchimedNetwork";
    if(type == ArchimedNetworkVariable) s = "ArchimedNetworkVariable";
