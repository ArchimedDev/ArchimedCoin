...
This mechanism has been integrated into Bitcore-Node-Archimed which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ArchimedDev/insight-api-archimed#web-socket-api](https://github.com/ArchimedDev/insight-api-archimed#web-socket-api)
* API: [https://github.com/ArchimedDev/insight-api-archimed#instantsend-transactions](https://github.com/ArchimedDev/insight-api-archimed#instantsend-transactions)
...
By default, the Archimed Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Archimed Core daemon:
