...
Archimed Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Archimed Core, where everyone uses
...
pay attention to for reviewers of Archimed Core code.

General Archimed Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Archimed Core uses tinyformat, which is type safe. Leave them out to avoid confusion
