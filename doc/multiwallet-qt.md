...
Only requiring some minor changes is archimed.cpp.
...
Changes to archimed.cpp
----------------------
archimed.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
